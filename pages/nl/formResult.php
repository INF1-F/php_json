        ...
        if(isset($_POST['education']) && !empty($_POST['education'])) {
            ...
            if(isset($_POST['location']) && !empty($_POST['location'])) {
                ...
                if(isset($_POST['message']) && !empty($_POST['message'])) {
                    ...
                    fclose($file);
                    $succesText = "<p>Bedankt voor het versturen! U krijgt zo spoedig mogelijk antwoord!</p>"; //waneer men het formulier verzend, komt er "bedankt voor het versturen te staan
                } else {
